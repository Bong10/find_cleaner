...
const JobFeatured9 = () => {
  ...
  const [jobSlider, setJobSlider] = useState([
    { id: 1, name: "One-Time Task", value: "freelancer", isChecked: false },
    { id: 2, name: "Recurring Job", value: "full-time", isChecked: true },
    { id: 3, name: "Move-Out Cleaning", value: "internship", isChecked: false },
  ]);
