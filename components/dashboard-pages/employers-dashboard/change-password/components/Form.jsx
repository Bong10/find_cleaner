  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      if (data && typeof data === "object") {
        // Map typical Djoser errors to inline + toasts
  ...
  return (
    <form className="default-form" onSubmit={onSubmit}>
        ...
        <div className="pw-row">
          ...
          <div className={`pw-input ${fieldErr.current_password ? "has-error" : ""}`}>
            <input
              ...
              onKeyUp={(e) => setCaps((c) => ({ ...c, cur: capsOn(e) }))}
        ...
        <div className="pw-row">
          ...
          <div className={`pw-input ${fieldErr.new_password ? "has-error" : ""}`}>
            <input
              ...
              onKeyUp={(e) => setCaps((c) => ({ ...c, new: capsOn(e) }))}
        ...
        <div className="pw-row">
          ...
          <div className={`pw-input ${fieldErr.re_new_password ? "has-error" : ""}`}>
            <input
              ...
              onKeyUp={(e) => setCaps((c) => ({ ...c, conf: capsOn(e) }))}
      ...
      <style jsx>{`
        ...
        .pw-strength .bar {
          width: 56px; height: 6px; border-radius: 999px; background: #e5e7eb;
        }
