  ...
  const regBannerContent = [
    {
      ...
      name: "Find Reliable Cleaners",
      text: `Connect with skilled, verified cleaners to get your tasks done quickly and efficiently.`,
      avatar: "/images/resource/employ.png",
      bannerClass: "banner-style-one",
      ctaButton: "Post a Task",
      width: "221",
      height: "281",
    },
    {
      ...
      text: `Create your profile and start finding cleaning jobs today.`,
