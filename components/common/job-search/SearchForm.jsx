      ...
      <div className="row">
        <div className="form-group col-lg-5 col-md-12 col-sm-12">
          ...
          <input
            type="text"
            name="field_name"
            placeholder="What type of cleaning do you need?"
          />
        </div>
        {/* <!-- Form Group --> */}
        ...
        <div className="form-group col-lg-4 col-md-12 col-sm-12 location">
          ...
          <input type="text" name="field_name" placeholder="Enter your location (city or postcode)" />
        </div>
        {/* <!-- Form Group --> */}
        ...
        <div className="form-group col-lg-3 col-md-12 col-sm-12 btn-box">
          ...
          >
            <span className="btn-title">Search Now</span>
          </button>
        </div>
      </div>
      {/* End .row */}
